...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L_RAISE] = LAYOUT(																															\
    ...
    _______,	KC_PSCR,	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX, /**/ KC_HOME,	KC_PGDN,	KC_PGUP,	KC_END,		KC_INS,		LGUI(KC_SPC),\
  ...
  [L_ADJUST] = LAYOUT(																																\
    _______,	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX, /**/ XXXXXXX,	    KC_MS_BTN1,	    KC_MS_BTN3,     KC_MS_BTN2,	 KC_MS_BTN4,	XXXXXXX,\
    _______,	XXXXXXX,	XXXXXXX,	DF(L_QWTY),	DF(L_CLMK),	XXXXXXX, /**/ KC_MS_LEFT,	KC_MS_DOWN,	    KC_MS_UP,       KC_MS_RIGHT, KC_MS_BTN5,	XXXXXXX,\
