...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L_QWTY] = LAYOUT(																																\
    ...
    KC_LSFT,	KC_Z,			KC_X,		KC_C,		KC_V,		KC_B,	 /**/ KC_N,		KC_M,		KC_COMM,	KC_DOT,		KC_SLSH,	KC_LGUI,\
											KC_LALT,	LOWER,		KC_SPC,  /**/ KC_ENT,	RAISE,		KC_LEAD										\
  ),
  ...
  [L_RAISE] = LAYOUT(																																\
    ...
    _______,	KC_MS_WH_UP,	KC_MS_BTN1,	KC_MS_UP,	KC_MS_BTN2,	XXXXXXX, /**/ KC_LEFT,	KC_DOWN,	KC_UP,		KC_RIGHT,	KC_DEL,		KC_F12, \
    _______,	KC_MS_WH_DOWN,	KC_MS_LEFT,	KC_MS_DOWN,	KC_MS_RIGHT,XXXXXXX, /**/ KC_HOME,	KC_PGDN,	KC_PGUP,	KC_END,		KC_INS,		_______,\
											_______,	_______,	_______, /**/ _______,	_______,	_______										\
  ),

  [L_ADJUST] = LAYOUT(																																\
    _______,	XXXXXXX,		XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX, /**/ XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,\
    _______,	XXXXXXX,		XXXXXXX,	DF(L_QWTY),	DF(L_CLMK),	XXXXXXX, /**/ KC_MPRV,	KC_VOLD,	KC_VOLU,	KC_MNXT,	XXXXXXX,	XXXXXXX,\
    _______,	XXXXXXX,		XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX, /**/ XXXXXXX,	XXXXXXX,	XXXXXXX,	XXXXXXX,	KC_MUTE,	_______,\
											_______,	_______,	_______, /**/ _______,	_______,	_______										\
  ),
