...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L_QWERTY] = LAYOUT(                                                                                  \
    KC_TAB,  KC_Q, KC_W, KC_E,    KC_R,  KC_T,   /**/ KC_Y,   KC_U,  KC_I,    KC_O,   KC_INS,  KC_BSPC, \
  ...
  [L_COLEMAK] = LAYOUT(                                                                                 \
    KC_TAB,  KC_Q, KC_W, KC_F,    KC_P,  KC_G,   /**/ KC_J,   KC_L,  KC_U,    KC_Y,   KC_INS,  KC_BSPC, \
  ...
  [L_LOWER] = LAYOUT(                                                                                                               \
    ...
    _______, KC_SCLN, KC_COLN, KC_UP,   KC_BSLASH, KC_UNDS,  /**/ KC_MINUS,  KC_EQUAL, KC_GT,   KC_LBRACKET, KC_RBRACKET, _______,  \
    _______, XXXXXXX, KC_LEFT, KC_DOWN, KC_RIGHT,  KC_TILD,  /**/ KC_PLUS,   KC_LT,    _______, _______,     _______,     KC_GRAVE, \
  ...
  [L_ADJUST] = LAYOUT(                                                                                                 \
    ...
    _______, KC_BRID, KC_BRIU, KC_MUTE, KC_VOLD, KC_VOLU, /**/ XXXXXXX, XXXXXXX, KC_PGUP,   XXXXXXX, XXXXXXX, _______, \
    _______, XXXXXXX, KC_PSCR, KC_MPLY, KC_MPRV, KC_MNXT, /**/ XXXXXXX, KC_HOME, KC_PGDOWN, KC_END,  XXXXXXX, _______, \
                               _______, _______, _______, /**/ _______, _______, _______                               \
  ),

  [L_EXTRA] = LAYOUT(                                                                                                                   \
    _______,         DF(L_QWERTY), XXXXXXX, XXXXXXX,       XXXXXXX, XXXXXXX, /**/ XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
    LSFT_T(KC_CAPS), XXXXXXX,      XXXXXXX, XXXXXXX,       XXXXXXX, XXXXXXX, /**/ XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
    _______,         XXXXXXX,      XXXXXXX, DF(L_COLEMAK), XXXXXXX, XXXXXXX, /**/ XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, \
                               _______, _______, _______,         /**/ _______, _______, _______                                        \
  ),
