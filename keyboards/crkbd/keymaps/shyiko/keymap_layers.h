...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L_LOWER] = LAYOUT(                                                                                                              \
    ...
    _______, KC_VOLD, KC_VOLU, KC_UP,   KC_BSLASH, KC_GRAVE, /**/ KC_MINUS,  KC_EQUAL, XXXXXXX, XXXXXXX, KC_LBRACKET, KC_RBRACKET, \
    _______, KC_MUTE, KC_LEFT, KC_DOWN, KC_RIGHT,  KC_ENT,   /**/ KC_INSERT, XXXXXXX,  KC_COMM, KC_DOT,  KC_SLSH,     _______,     \
  ...
  [L_RAISE] = LAYOUT(                                                                                                             \
    ...
    _______, KC_F11, KC_F12, XXXXXXX, KC_BSLASH, KC_GRAVE, /**/ KC_MINUS,  KC_EQUAL, KC_UP,   KC_APP,   KC_LBRACKET, KC_RBRACKET, \
    _______, KC_Z,   KC_X,   KC_C,    KC_V,      KC_ENT,   /**/ KC_INSERT, KC_LEFT,  KC_DOWN, KC_RIGHT, KC_SLSH,     _______,     \
                             _______, _______,   _______,  /**/ _______,   _______,  _______                                      \
  ),

  [L_ADJUST] = LAYOUT(                                                                                                 \
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, /**/ XXXXXXX, XXXXXXX, XXXXXXX,   XXXXXXX, XXXXXXX, XXXXXXX, \
    _______, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, /**/ _______, _______, KC_PGUP,   XXXXXXX, _______, _______, \
  ...
  [L_EXTRA] = LAYOUT(                                                                                                \
    ...
    KC_CAPS, KC_BRID, KC_BRIU, XXXXXXX, XXXXXXX, XXXXXXX, /**/ XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_PSCR, XXXXXXX, \
